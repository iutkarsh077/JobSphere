...
const Signup = () => {
  ...
  return (
    <>
    {!isVerifyEmail ? (<div className="h-screen w-screen flex justify-center items-center bg-gray-900 bg-center bg-cover" style={{ backgroundImage: "url('/images/jobBG2.jpeg')" }}>
